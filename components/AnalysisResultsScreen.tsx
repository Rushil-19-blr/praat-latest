...
const StressIndicator: React.FC<{ stressLevel: number }> = ({ stressLevel }) => {
  ...
  useEffect(() => {
    ...
    const progressControls = animate(0, percentage, {
      duration: 2.0,
      ease: 'easeOut',
      onUpdate: (value) => setProgressValue(value),
    });
  ...
  return (
    <div className="flex flex-col items-center">
      <FlameVisualization stressLevel={stressLevel} />
      <div className="relative w-[240px] h-[240px]">
        <svg className="w-full h-full" viewBox="0 0 100 100">
          ...
          <motion.circle
            ...
            animate={{ strokeDashoffset: 1 - progressValue }}
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          <motion.h1 
            className="font-sans font-thin text-7xl text-white"
...
const FlameVisualization: React.FC<{ stressLevel: number }> = ({ stressLevel }) => {
  const flameHeight = Math.max(20, (stressLevel / 100) * 80);
  const flameIntensity = stressLevel / 100;
  ...
  return (
    <div className="flex items-end justify-center h-24 mb-4">
      ...
      >
        <motion.div
          className="w-8 h-16 bg-gradient-to-t from-red-500 via-orange-400 to-yellow-300 rounded-full"
        ...
        />
        <motion.div
          className="absolute top-0 left-1 w-6 h-12 bg-gradient-to-t from-red-600 via-orange-500 to-yellow-400 rounded-full"
          style={{ height: `${flameHeight * 0.8}px` }}
          animate={{
            scale: [1, 1.2, 1],
            opacity: [0.6, 1, 0.6]
          }}
